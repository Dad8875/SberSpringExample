package sber.dad.libraryproject.service.userdetails;
...
import sber.dad.libraryproject.constants.UserRoleConstants;
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        if (username.equals(adminUsername)) {
            ...
            authorities.add(new SimpleGrantedAuthority(user.getRole().getId() == 1L ?
                    "ROLE_" + UserRoleConstants.USER : "ROLE_" + UserRoleConstants.LIBRARIAN));
